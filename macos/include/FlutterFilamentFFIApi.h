...
FLUTTER_PLUGIN_EXPORT int get_hierarchy_entity_count_ffi(void* const assetManager, EntityId asset);
FLUTTER_PLUGIN_EXPORT void get_hierarchy_entity_name_ffi(void* const assetManager, EntityId asset, char *const outPtr, int index);
